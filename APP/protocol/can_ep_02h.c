...
//	CanInPutTask(canf);
//}
//static void Can_Ep_02h_TmrSend(UINT8 ucCommand)
//{
//	
//}


//static void Can_Ep_02h_Handler(STR_CAN_STD_TYPE *canf)  
//{                  
//    if (canf->J1939PRDP == 0x18 && canf->J1939PF == 0xCA && canf->J1939SA == 0xF6) 
//    {
//					
